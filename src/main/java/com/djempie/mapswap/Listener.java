...
public class Listener implements org.bukkit.event.Listener {
	...
	public void onPlayerJoin(PlayerJoinEvent event) {
		MapSwap.getInstance().getAdventureManager().addAdventurePlayer(new BukkitAdventurePlayer(event.getPlayer()));
	}
	...
	public void onPlayerPortal(PlayerPortalEvent event) {
		...
		BukkitAdventurePlayer player = (BukkitAdventurePlayer)MapSwap.getInstance().getAdventureManager().getAdventurePlayer(bukkitPlayer.getName());
